...
while true; do
	...
	$testDir/mergeBathy ../output_files/T10C05_CPP_DUCK_10x10g_20x100s_10x10GMT_e 10 hann ../../../Test_Set_10_OSP_Paper/Active_Testing_Site/input_file_lists/input_file_list_duckExample_e.txt -75.749690 36.177602 18.20 -1 -nmsei -msri -multiThread 8 -mse 1 -msmooth 20 100 -modelflag -nonegdepth -GMTSurface 10 10 ../output_files/T10C05_CPP_DUCK_10x10g_20x100s_10x10GMT_e_xyze 0.1 1.96 2 -2 > ../command_line_execution/T10C05_DUCK_10x10g_20x100s_10x10GMT_e_output.txt
	echo "done." 
	echo ""
	...
	#j mgrid 926 smooth 1234.67 mbz 617.33
	$testDir/mergeBathy ../output_files/T10C07_CPP_DBDBV_0.5_NoOverlap_MBZK_e 926 hann ../../../Test_Set_10_OSP_Paper/Active_Testing_Site/input_file_lists/DBDBV_test_input_file_list_NoOverlap_e.txt -129 49.5 0 -1 -nmsei -msri -multiThread 8 -mse 1 -modelflag -msmooth 1234.67 1234.67 -ZGrid 617.33 617.33 ../output_files/T10C06_CPP_DBDBV_0.5_NoOverlap_MBZ_e_xyde 0.1 -2 -kriging > ../command_line_execution/T10C07_DBDBV_MBZK_e_output.txt
	echo "done." 
	echo ""
