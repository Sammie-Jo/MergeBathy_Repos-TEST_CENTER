...
:runMe
	...
	%testDir%\mergeBathy.exe ..\output_files\T10C05_CPP_DUCK_10x10g_20x100s_10x10GMT_e 10 hann ..\..\..\Test_Set_10_OSP_Paper\Active_Testing_Site\input_file_lists\input_file_list_duckExample_e.txt -75.749690 36.177602 18.20 -1 -nmsei -msri -multiThread 8 -mse 1 -msmooth 20 100 -modelflag -nonegdepth -GMTSurface 10 10 ..\output_files\T10C05_CPP_DUCK_10x10g_20x100s_10x10GMT_e_xyze 0.1 1.96 2 -2 > ..\command_line_execution\T10C05_DUCK_10x10g_20x100s_10x10GMT_output_e.txt
	echo ...done.
	echo.
